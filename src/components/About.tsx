...
export function About() {
  return (
    // AJUSTE: Reduzi o py-16 para py-10 no mobile, e px-6 para px-4
    <main
      id="sobre"
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col">
          ...
          {/* AJUSTE: gap-4 no mobile, volta para gap-6 no desktop */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 h-full">
            {/* Card 1 - Gamer */}
            {/* AJUSTE: p-6 no mobile, p-8 no desktop. Arredondamento menor no mobile */}
            ...
            >
              {/* Ícone fixo. Animação de shake apenas no desktop (lg:group-hover) */}
              ...
              {/* TEXTO SURPRESA (Aparece no hover APENAS EM TELAS GRANDES) */}
